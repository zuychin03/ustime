...
<template>
	...
	<button
		...
		:key="i"
		type="button"
		class="absolute inset-x-0.5 z-20 cursor-pointer transition hover:brightness-110 focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none focus-visible:ring-inset"
		:style="styleFor(seg)"
